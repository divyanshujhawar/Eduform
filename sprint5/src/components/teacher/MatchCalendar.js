...
class MatchCalendar extends React.Component {
    ...
    getAllAssignmentsInMonth() {
        ...
        console.log('URL: ', '/student/getAllAssignmentsInMonth/'+ 'shubham@iu.edu' + `?month=${month}&year=${year}`);
        ...
        try {
            const response = fetch('/student/getAllAssignmentsInMonth/'+ UserProfile.getEmail() + `?month=${month}&year=${year}`, {
                ...
                .then(jsonData => {
                    ...
                    console.log("Assignments we get: ", this.state.assignments);
