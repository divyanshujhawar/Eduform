...
import Assignments from '../teacherCourses/AssignmentBlocks.js';
import NavBar from '../teacher/TeacherNavigation.js';
                ...
                <div style={{ paddingLeft: `${this.state.itemPad}px`, paddingRight: '5%' }} className="flex-container">
                    ...
                    <div style={{ marginTop: '30px' }} className="row">
                        ...
                        <div style={{ textAlign: 'left' }} className="col-md-12 col-sm-8">
                            ...
                            }} > <i style={{ color: '#febf63', marginRight: '20px' }} class="fas fa-chevron-circle-left"></i> </Link>Created Assignments
                            </h1>
                        </div>
