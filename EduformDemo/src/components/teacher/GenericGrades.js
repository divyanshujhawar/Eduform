...
class GenericGrades extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            myCourse : this.props.location.currentClassGrade,
        ...
        this.getStudentsEnrolled = this.getStudentsEnrolled.bind(this);
    ...
    {
        try {
            const response = fetch('/teacher/getCourseAssignments/' + this.state.myCourse, {
                method: 'GET',
                ...
                .then(jsonData => {
                    ...
                    this.setState({
                        studentsEnrolled: jsonData.result
                    });

                   // console.log(this.state.myCourse);
                    //console.log(this.state.studentsEnrolled[0]);
    ...
    render() {
        ...
        if(!(this.state.studentsEnrolled === undefined)){
