                ...
                <div style={{paddingTop: '4%', paddingBottom: '5%'}} className="container">
                    ...
                    <div style={{padding: '0% 3% 1% 3%', paddingTop: '2%'}} className="col-lg-5 col-md-7 bg-black myLogIn text-primarys">
                        <form onSubmit={this.handleSubmit} noValidate>
                            ...
                            <h1 className="welcome" style={{color: '#febf63',marginTop: '1.5%', fontSize: '2.5rem', paddingBottom: '10px'}}> Login to EduForm </h1>
                            ...
                            <button type="submit" className="adminWordHead btn btn-block log" style={{fontSize: '1.2rem', backgroundColor: '#febf63'}}> <b>Log In </b></button>

                            <p style={{fontSize: '1.1rem', marginTop: "5px"}} className="forgot-password text-left">
