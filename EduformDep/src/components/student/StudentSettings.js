...
import Upcoming from './UpcomingAssignments.js';
...
class StudentSettings extends React.Component {
  ...
  changeTheme = (value) => {
    ...
    if(value === "iu"){
      this.setState({theBackground : iuVals[0], theWords : iuVals[1], others : iuVals[2], pageTheme : 'iu', headerWord : iuVals[3], selectheaderback : iuVals[4],
        colorOfHeadWord : iuVals[5]})
   
    }
    else if(value === "bat"){
      this.setState({theBackground : batVals[0], theWords : batVals[1], others : batVals[2], pageTheme : 'bat',headerWord : batVals[3], selectheaderback : batVals[4],
      colorOfHeadWord : batVals[5]})
    }
    else if(value === "dino"){
      this.setState({theBackground : dinoVals[0], theWords : dinoVals[1], others : dinoVals[2], pageTheme : 'dino',headerWord : dinoVals[3], selectheaderback : dinoVals[4],
      colorOfHeadWord : dinoVals[5]})
    }
    else{
      this.setState({theBackground : eduVals[0], theWords : eduVals[1], others : eduVals[2], pageTheme : 'edu',headerWord : eduVals[3], selectheaderback : eduVals[4],
               ...
               <div style={{marginBottom: '10px'}}className="col-md-3 col-sm-12">
                  <div class="card">
                    ...
                    <div class="content">
                      ...
                      <div class="meta">
                      <button style={{backgroundColor: '#a20a0a',color: 'white'}} type="button" onClick={() => this.changeTheme("iu")} class="btn">Go Hoosiers!</button>
                      </div>
                    </div>
                  ...
                  <div style={{marginBottom: '10px'}}className="col-md-3 col-sm-12">
                  <div style={{backgroundColor: 'white'}} class="card">
                    <div class="blurring dimmable image">
                      <div class="ui dimmer">
                        <div class="content">
                          <div class="center">
                    ...
                    <div class="content">
                      ...
                      <div class="meta">
                      <button style={{backgroundColor: '#febf63', color: '#1089ff'}} onClick={() => this.changeTheme("edu")}  type="button" class="btn">Welcome Back!</button>
                      </div>
                    </div>
                  ...
                  <div style={{marginBottom: '10px'}}className="col-md-3 col-sm-12">
                  <div style={{backgroundColor: '#fddb3a'}} class="card">
                    <div class="blurring dimmable image">
                      <div class="ui dimmer">
                        <div class="content">
                          <div class="center">
                    ...
                    <div class="content">
                      ...
                      <div class="meta">
                      <button style={{backgroundColor: '#4c4c4c', color: 'white'}} onClick={() => this.changeTheme("bat")} type="button" class="btn">Suit Up!</button>
                      </div>
                    </div>
                  ...
                  <div style={{marginBottom: '10px'}} className="col-md-3 col-sm-12">
                  <div style={{backgroundColor: '#cbbcb1'}} class="card">
                    <div class="blurring dimmable image">
                    ...
                    <div class="content">
                      ...
                      <div class="meta">
                      <button style={{backgroundColor: '#8db596'}} onClick={() => this.changeTheme("dino")} type="button" class="btn">Watch your back!</button>
                      </div>
                    </div>
