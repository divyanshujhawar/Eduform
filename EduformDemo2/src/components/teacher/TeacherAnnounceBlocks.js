...
class TeacherAnnounceBlocks extends React.Component {
    ...
    render() {
        ...
        for (i; i < this.state.lastWeekAnnouncements.length; i++) {
            ...
            theNotes.push(
                <a style={{textAlign: 'left',marginBottom: '5px', backgroundColor: '#1089ff' }} href="#" class="item">
                    <a style={{color: '#febf63' }} class="header"><p style={{textAlign: 'left'}}>{this.state.lastWeekAnnouncements[i].courseCode}</p></a>
