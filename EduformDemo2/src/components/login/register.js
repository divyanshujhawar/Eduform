        ...
        <div className="registerPageHeader">
            ...
            <div style={{paddingTop: '4%', paddingBottom: '2%'}} className="container">
                ...
                <div style={{padding: '0% 3% 1% 3%', paddingTop: '2%'}} className="col-lg-5 col-md-7 bg-black myLogIn text-primarys">
                    ...
                    <h1 className="welcome" style={{color: '#febf63',marginTop: '1.5%', fontSize: '2.5rem', paddingBottom: '10px'}}> Register for EduForm! </h1>

                                
                            <div className="form-group" style ={{alignSelf: 'center', backgroundColor: '#1089ff'}}>
                                <select name="role" id="role" name="role" style={{width: '100%',fontSize: '.9rem'}}>
                            ...
                            */}
                            ...
                            <button type="submit" className="adminWordHead btn btn-block log" style={{fontSize: '1.2rem', backgroundColor: '#febf63'}}> <b> Register </b></button>
